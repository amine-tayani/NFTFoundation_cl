      ...
      <div className="flex justify-end max-w-xl mx-auto xl:pr-14 lg:max-w-screen-xl">
        <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
          ...
          <div className="flex flex-col space-y-2 md:space-y-0 md:flex-row ">
            <button className="inline-block text-center h-14 px-40 md:px-24 duration-200 transform bg-black text-white rounded-xl focus:outline-none hover:-translate-y-1 hover:shadow-md md:mr-2 focus:shadow-outline font-semibold">
              Place a bid
            </button>
